  ...
  return (
    <div class="bg-gray-200 w-full px-16 md:px-0 h-screen flex items-center justify-center">
      <div class="bg-white border border-gray-200 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
        ...
        <a
          href="/"
          class="flex items-center space-x-2 border-2 border-gray-900 text-black hover:text-white text-center text-sm focus:outline-none hover:bg-gray-900 px-4 py-2 mt-6 rounded transition duration-150"
          title="Return Home"
        >
          <svg
