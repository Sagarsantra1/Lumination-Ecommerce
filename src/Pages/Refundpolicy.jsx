function Refundpolicy() {
    return (     <div className="text-left px-32 space-y-3">
    <h1 className="text-center text-3xl">Terms of service</h1>
    <h2 className="text-xl text-black">OVERVIEW</h2>
    <div className="space-y-5 text-gray-700">
      <p>
        This website is operated by Joyous Beam Candles. Throughout the site,
        the terms “we”, “us” and “our” refer to Joyous Beam Candles. Joyous
        Beam Candles offers this website, including all information, tools and
    ...
    <h2 className="text-xl text-black">SECTION 1 - ONLINE STORE TERMS</h2>
    <div className="space-y-5 text-gray-700">
      {" "}
      <p>
    ...
    <h2 className="text-xl text-black">SECTION 2 - GENERAL CONDITIONS</h2>
    <div className="space-y-5 text-gray-700">
      {" "}
      <p>
      ...
      <p>
        ou agree not to reproduce, duplicate, copy, sell, resell or exploit
